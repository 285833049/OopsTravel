...
public class NewsInfoPageDAO {
	public List<Newsinfo> pageQuery(int pageSize,int pageNow,List<Newsinfo> objectlist){
		...
		public int pageTotle(int pageSize, int pageNow) {
			...
			i = session.createQuery("from Newsinfo").list().size();
