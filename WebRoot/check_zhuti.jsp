<%-- 
    Document   : check_zhuti
    Created on : 2013-2-21, 12:30:06
    Author     : Elizabeth
--%>
...
.container-fluid .row-fluid #content .row-fluid.sortable .box.span12 .box-content p {
	text-align: center;
}
</style>
		...
		<div>查看</div>
            ...
            <div>
				<ul class="breadcrumb">
                    ...
                    <li>
						<a href="check_zhuti.jsp">查看主题</a>
					</li>
				</ul>
			</div><div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-picture"></i>主题</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<p>
							<button style="height:80px; width:160px;"  onclick="window.open('check_tiezi.jsp')" class="btn btn-large btn-primary">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-danger">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-warning">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-success">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-info">主题的名字</button>&nbsp;
						<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-inverse">主题的名字</button>&nbsp;</p>
					  <p>
                            <button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-primary">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-danger">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-warning">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-success">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-info">主题的名字</button>&nbsp;
							<button style="height:80px; width:160px;" onClick="window.open('check_tiezi.jsp')"class="btn btn-large btn-inverse">主题的名字</button>&nbsp;
						</p>
